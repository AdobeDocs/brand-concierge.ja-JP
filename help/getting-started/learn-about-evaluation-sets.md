---
title: 評価セットについて詳しく見る
description: Brand Conciergeの評価セットを利用して、正解が得られるか、スコープが限定されるかのテストを実施し、少々厄介な質問を本番稼働前に安全に処理する方法をご確認ください。
...
* マーケターとコンテンツ所有者による
* 本番稼働前にコンシェルジュの回答を検証している人
* コンシェルジュの品質と安全性を担当するチーム

## ビデオコンテンツ

* 評価タイプは、機能的、スコープ外、セーフガードの3つです
* 評価セットの構築方法：AIが生成した質問や独自のCSV アップロード
